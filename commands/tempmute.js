...
module.exports.run = async (bot, message, args) => {
  ...
  if(!message.member.hasPermission("MANAGE_MESSAGES")) return message.reply("You can't do that, Darling.");
  if(args[0] == "help"){
  ...
  if(tomute.hasPermission("MANAGE_MESSAGES")) return message.reply("Can't mute them, Darling.");
